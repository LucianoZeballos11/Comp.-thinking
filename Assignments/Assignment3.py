...
try: 
    ...
    if hours == float:
        print("Error, do not use numbers with decimals")
    rate = int(input("Enter Rate:\n > ")) #user's input
    salary = hours * rate #formula for salary below 40 hours of work
    extra = hours - 40 #formula to know to amount of hours worked after 40 hours
    salary2 = float(((extra * 1.5) * rate) + 400) #forumla for salary over 40 hours of work
except:
